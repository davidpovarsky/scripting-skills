...
const H={schedule:"לוח זמנים",date:"תאריך",trips:"נסיעות",last:"האחרון",first:"הראשון",loading:"טוען...",failed:"לא ניתן לטעון את לוח הזמנים",none:"אין נסיעות בתאריך שנבחר"}
