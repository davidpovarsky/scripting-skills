...
export type TransitConfig =
 ...
 | {type:"segment";lineNumber?:string;fromStop:Stop;toStop:Stop;durationMinutes:number;minMinutes?:number;maxMinutes?:number;stopCount?:number;date?:string;headsign?:string;source?:string;currentLive?:{durationMinutes:number;vehicleId?:string;tripId?:string;fromEta?:string;toEta?:string;lastReported?:string};recentActual?:{durationMinutes:number;vehicleId?:string;tripId?:string;fromTime?:string;toTime?:string;completedAt?:number;precisionSeconds?:number}[];recentActualMedianMinutes?:number;scheduled?:{durationMinutes:number;tripId?:string;departureTime?:string;basis?:string};historyCollecting?:boolean;height?:number}
 ...
 | {type:"monitor";message?:string;monitor?:any;monitors?:any[];height?:number}
