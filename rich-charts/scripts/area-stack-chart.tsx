...
import { AreaStackChartProps, chartStyle, horizontalCategoryViewport, seriesColor } from "./types"

/** Stacked area chart. The configured stacking mode is intentionally separate from overlay AreaChartView. */
export function AreaStackChartView({ title, height, data, labelOnYAxis = false, stacking = "standard", colors, scrollable = "auto", visibleCategoryCount }: AreaStackChartProps) {
  ...
  const viewport = horizontalCategoryViewport(labels, labelOnYAxis, scrollable, visibleCategoryCount)
